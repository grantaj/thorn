...
+----------------------------------------------------+
        ...
        canonical typed / partial Proof IR
          ...
          - higher proof structure / transformations
...
A claim is therefore a frontend observation. It may elaborate to a hypothesis, goal, derived proposition, unresolved mathematical fragment or irreducible opaque proof step.
...
Canonical Proof IR turns recoverable load-bearing steps into explicit propositions, obligations or typed transformations and retains exact source handles for opaque material. The real-paper fidelity work in #75 / PR #76 strengthened this into an anti-loss invariant: a recovered proof edge must not depend on mathematics that is neither represented in Proof IR nor source-reachable.
...
Canonical binder identity and scope resolution belong to the Proof IR elaboration layer. The support extractor provides evidence without guessing final binding structure.
...
Issue #59 defines the project north star: compile ordinary mathematical writing into the strongest faithful computer proof IR Thorn can recover.

The support layer contributes evidence to that process, while canonical Proof IR replaces narration-shaped concepts with mathematical structure whenever the stronger interpretation is justified:
...
If the stronger interpretation is not justified, keep an explicit unresolved operation and exact source rather than guessing.

This is an anti-regression rule: **do not preserve generic claim/support vocabulary as final semantics merely because it was convenient during extraction.**
...
These fixtures strengthen deterministic evidence recovery without implying that support-edge success is equivalent to proof understanding. Separate Proof IR tests establish stronger canonical semantics and metamorphic invariants.
